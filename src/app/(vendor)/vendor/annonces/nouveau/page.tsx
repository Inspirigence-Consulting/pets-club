        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          <Card className="border-[var(--color-cream-dark)]">
            <CardHeader>
              ...
              <CardDescription>
                Décrivez l&apos;animal que vous souhaitez vendre
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="description"
                  name="description"
                  placeholder="Décrivez l'animal en détail : caractère, santé, vaccins, pedigree..."
          ...
          <Card className="border-[var(--color-cream-dark)]">
            <CardHeader>
              ...
              <CardDescription>
                Informations de contact pour les acheteurs
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid gap-4 sm:grid-cols-2">
            ...
            <CardContent className="space-y-4">
              ...
              {form.photos.length === 0 && (
                <div className="flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-[var(--color-cream-dark)] py-8 text-[var(--color-text-muted)]">
                  ...
                  <p className="text-xs">
                    Ajoutez des URLs de photos ci-dessus
                  </p>
                </div>
              )}
            </CardContent>
        ...
        <div className="space-y-6">
          ...
          {showPreview && (
            <Card className="border-[var(--color-cream-dark)]">
              ...
              <CardContent className="space-y-3">
                {form.photos[0] ? (
                  <div className="aspect-square overflow-hidden rounded-lg bg-[var(--color-cream)]">
                    <img
                      src={form.photos[0]}
                      alt="Preview"
                      className="size-full object-cover"
                  ...
                  <div className="flex aspect-square items-center justify-center rounded-lg bg-[var(--color-cream)]">
                    <ImageIcon className="size-12 text-[var(--color-text-muted)]" />
                  </div>
                )}
                ...
                <p className="text-xs text-[var(--color-text-light)]">
                  {form.breed || "Race"} &middot;{" "}
                  {form.gender === "MALE" ? "Mâle" : "Femelle"} &middot;{" "}
                  {form.age || "Âge"}
                </p>
                <p className="text-sm font-semibold text-[var(--color-gold-dark)]">
                  {form.price
                    ? `${Number(form.price).toLocaleString("fr-MA")} MAD`
                    : "Prix"}
                </p>
                <p className="text-xs text-[var(--color-text-muted)]">
                  {form.city || "Ville"} &middot;{" "}
                  {form.phone || "Téléphone"}
                </p>
                {form.description && (
                  <p className="line-clamp-3 text-xs text-[var(--color-text-light)]">
                    {form.description}
                  </p>
                )}
              </CardContent>
